...
public class ShowMyPuzzlesActivity extends AppCompatActivity {
            ...
            public void onResponse(JSONArray response) {
                ...
                try {
                    ...
                    for (int i = 0; i < contLength; i++) {
                        ...
                        ArrayAdapter<?> adapter = new ArrayAdapter<Object>(ShowMyPuzzlesActivity.this, android.R.layout.simple_selectable_list_item, list_item);
