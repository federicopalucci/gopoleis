    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        solve.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent go_to_answer = new Intent(ShowPuzzleActivity.this,PuzzleAnswerActivity.class);
        ...
        hint.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(ShowPuzzleActivity.this,indizio,Toast.LENGTH_LONG).show();
            }
        });

        /***********_______START TEMPLATE JSON REQUEST________**********/

        RequestQueue queue = Volley.newRequestQueue(ShowPuzzleActivity.this);
        ...
        JsonArrayRequest jsArray = new JsonArrayRequest(Request.Method.GET, url,null, new Response.Listener<JSONArray>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(ShowPuzzleActivity.this,"No Description...",Toast.LENGTH_LONG).show();
            }
        });
        ...
        RequestQueue queue2 = Volley.newRequestQueue(ShowPuzzleActivity.this);
        ...
        RequestQueue queue3 = Volley.newRequestQueue(ShowPuzzleActivity.this);
        ...
        RequestQueue queue4 = Volley.newRequestQueue(ShowPuzzleActivity.this);
    ...
    protected void onActivityResult(int requestCode,int resultCode, Intent data) {
        ...
        if (requestCode == 100) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                Toast.makeText(ShowPuzzleActivity.this,"THAT WAS EASY!!",Toast.LENGTH_LONG).show();

                /***********_______START TEMPLATE JSON REQUEST________**********/

                RequestQueue queue5 = Volley.newRequestQueue(ShowPuzzleActivity.this);
