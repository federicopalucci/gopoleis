...
public class PortalsMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        yellowPortalButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent openYellowPortal = new Intent(PortalsMainActivity.this, TreasurePortalPag1Activity.class);
        ...
        redPortalButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent openRedPortal = new Intent(PortalsMainActivity.this, PuzzlePortalActivity.class);
